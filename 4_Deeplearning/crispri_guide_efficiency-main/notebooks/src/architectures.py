...
class Crispr1DCNN(pl.LightningModule):
    ...
    def __init__(self, num_features, which_loss = "mse"):
        ...
        self.ln1 = nn.Linear(num_features+latent*8, 128)
...
class CrisprGRU(pl.LightningModule):
    ...
    def forward(self, x_sequence_40nt, x_features):
        ...
        x_sequence_40nt = x_sequence_40nt.permute(1, 0, 2)
        
        # GRU layer
        #_, gru_sequence_20nt = self.gru1(x_sequence_20nt)
        _, gru_sequence_40nt = self.gru2(x_sequence_40nt)
        ...
        # concat all layers
        #concat_layer = torch.cat((lin_features, lin_pam, lin_sequence_20nt, lin_sequence_30nt), 1)
        out = torch.cat((x_features, gru_sequence_40nt.squeeze(0)), 1)
